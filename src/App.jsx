    ...
    <div className="min-h-screen text-white bg-gray-900 flex">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          ...
          {/* Username Input */}
          <div className="bg-gray-800 rounded-lg p-6 mb-6 border border-gray-700 max-w-4xl mx-auto">
          ...
          {/* AI Recommendation */}
          {recommendation && (
            <div className="bg-gradient-to-r from-purple-900 to-blue-900 rounded-lg p-6 border border-purple-700 max-w-4xl mx-auto">
